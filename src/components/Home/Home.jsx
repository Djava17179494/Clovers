    ...
    return (
        ...
        <div className='delivery-local'>
          <div className='flex-text'>
            <div><img src={Truck} alt="" className='photo-basket'/></div>
          ...
          <div className='flex-text'>
            <div><img src={Basket1} alt="" className='photo-basket'/></div>
            <div className='left-text'>
              <p className='text-weight'>Local Pickup</p>
               <p>Check out <a Locations/></p> 
              </div>
          </div>
          <div className='empty1'></div>
          <div className='flex-text'>
            <div><img src={Woman} alt="" className='photo-basket'/></div>
            <div className='left-text'>
              <p className='text-weight'>Avialable for You</p>
              <p><a>Online Support</a> 24/7</p>
            </div>
          </div>
          <div className='empty1'></div>
          <div className='flex-text'>
            <div><img src={Iphone} alt="" className='photo-basket'/></div>
            <div className='left-text'>
        ...
        <div>
          <div className='background-photo1 relative'>
           <div className='great-deals'>
            ...
            <div className='limited'><p>Limited Supply</p></div>
          </div>
